...
.showMsg h5 {
	background-image: url(<?php echo YUrl::assets('image', '/msg.png');?>);
...
.showMsg .ok, .showMsg .guery {
	background: url(<?php echo YUrl::assets('image', '/msg_bg.png');?>)
	no-repeat
	0px
	-560px;
}
...
<script type="text/javaScript"
	src="<?php echo YUrl::assets('js', '/jquery.min.js'); ?>"></script>
<script language="JavaScript"
	src="<?php echo YUrl::assets('js', '/backend_common.js'); ?>"></script>
</head>
<body>
